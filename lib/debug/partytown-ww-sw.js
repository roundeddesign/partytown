/* Partytown 0.10.2-dev1729629446617 - MIT builder.io */
(self => {
    ...
    const getPartytownScript = () => `<script src="${partytownLibUrl("partytown.js?v=0.10.2-dev1729629446617")}"><\/script>`;
                    ...
                    if (!hasInitializedMedia) {
                        (() => {
                            if (!webWorkerCtx.$initWindowMedia$) {
                                ...
                                webWorkerCtx.$importScripts$(partytownLibUrl("partytown-media.js?v=0.10.2-dev1729629446617"));
